...
const addProduct = async (product) => {
    const { title, description, price, thumbnail, code, stock } = product; // se crea un objeto con las propiedades desestructuradas
...
const updateProductById = async (id, dataProduct) => {
